...
/* swipe-to-delete functionality for recyclerview items
   adapted from android developer docs - itemtouchhelper.simplecallback
...
abstract class SwipeToDeleteCallback(context: Context) :
    ...
    private val backgroundColor = ContextCompat.getColor(context, R.color.ios_red)
