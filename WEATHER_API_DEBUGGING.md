...
## API Details
- **API**: WeatherAPI.com
- **API Key**: ***REMOVED-SEE-LOCAL-PROPERTIES*** (stored in local.properties)
...
```
https://api.weatherapi.com/v1/current.json?key=***REMOVED-SEE-LOCAL-PROPERTIES***&q=50.4372,5.9714
```
